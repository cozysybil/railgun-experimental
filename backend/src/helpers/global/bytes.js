 ...
 */
function arrayToByteLength(byteArray, length) {
 ...
 * @returns byte array
 */
function bigIntToArray(bn, length) {
 ...
 * @returns hex string
 */
function arrayToHexString(array, prefix) {
 ...
 * @param side - side to add padding "left" | "right"
 * @returns padded data
 */
